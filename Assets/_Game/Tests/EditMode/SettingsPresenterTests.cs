...
namespace Game.Architecture.Tests
{
    ...
    public sealed class SettingsPresenterTests
    {
        ...
        [Test]
        public void Feedback_Send_SaysItCannotBeDeliveredYet_AndKeepsThePanelOpen()
        {
            using var presenter = Started();
            view.Feedback();
            view.TypeFeedback("소리가 너무 작아요");
            ...
            Assert.That(view.Notices, Is.EqualTo(new[] { SettingsStyle.FeedbackNoticeMessage }));
            Assert.That(
                view.FeedbackVisible,
                Is.True,
                "Closing it would throw away what was written.");
        }
