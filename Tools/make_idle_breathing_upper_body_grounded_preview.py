...
OUT_BLEND = Path("/private/tmp/PurplePlayerCapsule_Idle_Breathing_upper_body_grounded_preview.blend")
OUT_FBX = Path("/private/tmp/PurplePlayerCapsule_Idle_Breathing_upper_body_grounded_preview.fbx")
FRAME_START = 1
FRAME_END = 60
...
def main():
    ...
    action = bpy.data.actions.new("Idle_Breathing_UpperBody_Grounded")
