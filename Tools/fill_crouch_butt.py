"""Inflate the squashed crouch butt in rest space. Arms are left untouched.

Blender --background --python Tools/fill_crouch_butt.py -- INPUT.fbx OUTPUT.fbx
"""
import sys
...
print("FILLED_BUTT", input_path, "->", output_path)
